...
- 数据模型以用户、部门、权限、题库、试题、内部试卷、考试、作答和成绩为核心。
...
- 🧑‍💼 管理部门树，支持在线维护、Excel 模板下载和 Excel 导入。
- 📚 维护题库、试题、选项、答案、解析、难度和附件；试题 Excel 导入只处理文本题目，富媒体在网页试题编辑页维护。
- 🚀 发布考试，按题库规则选择单选/多选题量和分值，维护总分、及格分、考试时长、限时、可考次数、题目显示方式、状态和部门开放范围。
...
| 模块 | 能力 |
| --- | --- |
| 身份权限 | 登录、当前用户、用户管理、角色管理、部门管理、角色权限配置 |
| 题库试题 | 题库、分类、单选题、多选题、选项、答案、解析、附件、Excel 导入 |
| 考试管理 | 题库管理、试题管理、考试管理、按题库规则组卷、考试状态维护、部门开放 |
