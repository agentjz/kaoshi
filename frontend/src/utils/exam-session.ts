...
export function isQuestionAnswered(question: ExamQuestion, singleAnswers: SingleAnswerMap, multipleAnswers: MultipleAnswerMap) {
...
export function countAnsweredQuestions(
  ...
  return questions.filter((question) => isQuestionAnswered(question, singleAnswers, multipleAnswers)).length
}
